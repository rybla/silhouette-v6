...
module.exports = {
  forbidden: [
    {
      name: "no-import-from-exe",
      comment:
        "The modules in src/exe are treated as executable scripts, which should not be imported by any library modules.",
      severity: "error",
      from: {
        pathNot: "^src/exe/",
      },
    ...
    },
    {
      ...
      from: {
        path: "^(src)",
        pathNot:
          "([.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)|[.d.ts])$",
      },
      to: {
